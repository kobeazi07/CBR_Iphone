                                    ...
                                    <div class="modal fade" id="tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('AdminTambahjenis')}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label for="" class="mb-2 text-secondary">Nama Kerusakan</label>
                                                    <input class="form-control form-control-lg" name="nama_kerusakan" type="text" placeholder="masukkan Kategori">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="" class="mb-2 text-secondary">Solusi</label>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                            <form action="{{route('AdminEditjenis', $jenis->id)}}" method="POST"  enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="" class="mb-2 text-secondary">Nama Jenis</label>
                                                <input class="form-control form-control-lg" value="{{$jenis->nama_kerusakan}}" name="nama_kerusakan" type="text" placeholder="masukkan Kategori">
                                              
                                            </div>
                                              <div class="form-group">
                                                                <label for="message-text" class="col-form-label">Solusi</label>
                                                                <textarea class="form-control" name="solusi">{{$jenis->solusi}}</textarea>
                                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                <button type="submit" class="btn btn-primary">Save changes</button>
